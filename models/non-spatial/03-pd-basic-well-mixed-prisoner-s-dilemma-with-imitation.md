...
![3. PD Basic, a well-mixed prisoner's dilemma with imitation](figures/03-pd-basic-well-mixed-prisoner-s-dilemma-with-imitation.png)

**Reproduce:** [`03-pd-basic-well-mixed-prisoner-s-dilemma-with-imitation.R`](scripts/03-pd-basic-well-mixed-prisoner-s-dilemma-with-imitation.R)
