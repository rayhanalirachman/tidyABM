...
This file has been split into a folder, which lives alongside the
package rather than inside it. Every model now has its own page, with
the concept, the NetLogo original where one exists, the package code and
the numbers the run produced.

**→
[`../models/README.md`](https://rayhanalirachman.github.io/models/README.md)**
...
| [Reproduction scripts](https://rayhanalirachman.github.io/models/scripts/README.md) | the runs behind the tables |
