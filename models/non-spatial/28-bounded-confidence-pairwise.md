...
![28. Bounded confidence, pairwise (Deffuant, Neau, Amblard & Weisbuch 2000)](figures/28-bounded-confidence-pairwise.png)

**Reproduce:** [`28-bounded-confidence-pairwise.R`](scripts/28-bounded-confidence-pairwise.R), [`28-bounded-confidence-pairwise-peaks.R`](scripts/28-bounded-confidence-pairwise-peaks.R)
