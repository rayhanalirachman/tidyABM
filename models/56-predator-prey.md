...
Running the same code with the other pairing mode gives no cycle at all —
sheep between 1 and 1083, wolves between 2 and 61, wandering near extinction.
...
density first — `eligible = .group == "sheep" | runif(n()) < n_sheep / area` —
