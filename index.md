...
| [`abm_sequential()`](https://rayhanalirachman.github.io/tidyabm/reference/abm_sequential.md) | updates them one at a time, in shuffled order |
...
three rounds of ten ported as stress tests.

Every feature in the package that is not in the founding thirteen exists
because one of those thirty models asked for it —
...
the `one_of` pairing mode, `among =`, `.scope = "population"`, clique
