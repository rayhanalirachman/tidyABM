...
![48. A garbage can model of organizational choice (Cohen, March & Olsen 1972)](figures/48-garbage-can-model.png)

**Reproduce:** [`48-garbage-can-model.R`](scripts/48-garbage-can-model.R)
