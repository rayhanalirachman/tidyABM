...
![37. Virus on a Network (Stonedahl & Wilensky 2008, NetLogo Networks)](figures/37-virus-on-a-network.png)

**Reproduce:** [`37-virus-on-a-network.R`](scripts/37-virus-on-a-network.R)
