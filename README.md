...
<!-- badges: start -->
[![R-CMD-check](https://github.com/rayhanalirachman/tidyabm/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/rayhanalirachman/tidyabm/actions/workflows/R-CMD-check.yaml)
